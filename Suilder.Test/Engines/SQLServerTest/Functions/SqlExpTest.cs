...
namespace Suilder.Test.Engines.SQLServerTest.Functions
{
    public class SqlExpTest : SQLServerBaseTest
    {
        [Fact]
        public void Abs()
        {
        ...
        public void LastInsertId()
        {
            ...
            Assert.Equal("SCOPE_IDENTITY()", result.Sql);
            Assert.Equal(new Dictionary<string, object>(), result.Parameters);
        }
        ...
        public void Length()
        {
            ...
            Assert.Equal("LEN([person].[Name])", result.Sql);
            Assert.Equal(new Dictionary<string, object>(), result.Parameters);
        }
        ...
        public void Now()
        {
            ...
            Assert.Equal("SYSDATETIME()", result.Sql);
            Assert.Equal(new Dictionary<string, object>(), result.Parameters);
        }
