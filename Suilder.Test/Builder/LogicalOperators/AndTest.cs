...
namespace Suilder.Test.Builder.LogicalOperators
{
    public class AndTest : BuilderBaseTest
    {
        ...
        [Theory]
        [InlineData(1000, 10, "efgh")]
        public void Expression_And_Parentheses_Center(decimal value1, int value2, string value3)
        {
            Person person = null;
            IOperator op = sql.Op(() => person.Id == 1 & person.Active & (person.Name.Like("%abcd%")
                & person.Salary > value1) & person.Address.Number == value2 & person.Address.City == value3);
        ...
        [Theory]
        [InlineData(1000, 10, "efgh")]
        public void Expression_AndAlso_Parentheses_Center(decimal value1, int value2, string value3)
        {
            Person person = null;
            IOperator op = sql.Op(() => person.Id == 1 && person.Active && (person.Name.Like("%abcd%")
                && person.Salary > value1) && person.Address.Number == value2 && person.Address.City == value3);
        ...
        [Theory]
        [InlineData(1000, 10, "efgh")]
        public void Expression_And_Parentheses_Right(decimal value1, int value2, string value3)
        {
            Person person = null;
            IOperator op = sql.Op(() => person.Id == 1 & person.Active & person.Name.Like("%abcd%")
                & person.Salary > value1 & (person.Address.Number == value2 & person.Address.City == value3));
        ...
        [Theory]
        [InlineData(1000, 10, "efgh")]
        public void Expression_AndAlso_Parentheses_Right(decimal value1, int value2, string value3)
        {
            Person person = null;
            IOperator op = sql.Op(() => person.Id == 1 && person.Active && person.Name.Like("%abcd%")
                && person.Salary > value1 && (person.Address.Number == value2 && person.Address.City == value3));
        ...
        [Theory]
        [InlineData(1000, 10, "efgh")]
        public void Expression_And_Parentheses_Both(decimal value1, int value2, string value3)
        {
            Person person = null;
            IOperator op = sql.Op(() => person.Id == 1 & person.Active & (person.Name.Like("%abcd%")
                & person.Salary > value1) & (person.Address.Number == value2 & person.Address.City == value3));
        ...
        [Theory]
        [InlineData(1000, 10, "efgh")]
        public void Expression_AndAlso_Parentheses_Both(decimal value1, int value2, string value3)
        {
            Person person = null;
            IOperator op = sql.Op(() => person.Id == 1 && person.Active && (person.Name.Like("%abcd%")
                && person.Salary > value1) && (person.Address.Number == value2 && person.Address.City == value3));
