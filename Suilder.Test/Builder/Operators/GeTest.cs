...
namespace Suilder.Test.Builder.Operators
{
    public class GeTest : BuilderBaseTest
    {
        ...
        public void Builder_Object(object value)
        {
            ...
            IOperator op = sql.Ge(person["Id"], value);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.Ge(person["Image"], value);
        ...
        public void Builder_Object_List<T>(List<T> value)
        {
            ...
            IOperator op = sql.Ge(dept["Tags"], value);
        ...
        public void Builder_Object_Column()
        {
            IAlias person = sql.Alias("person");
            IAlias dept = sql.Alias("dept");
            IOperator op = sql.Ge(person["DepartmentId"], dept["Id"]);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.Ge((object)null, person["Name"]);
        ...
        {
            Person person = null;
            IOperator op = sql.Ge(() => person.Department.Id, value);
        ...
        {
            Person person = null;
            IOperator op = sql.Ge(() => person.Address.Street, value);
        ...
        {
            Person2 person = null;
            IOperator op = sql.Ge(() => person.Address.City.Country.Name, value);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = person["Id"].Ge(value);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = person["Image"].Ge(value);
        ...
        {
            IAlias dept = sql.Alias("dept");
            IOperator op = dept["Tags"].Ge(value);
        ...
        {
            Person person = null;
            IOperator op = sql.Op(() => SqlExp.Ge(person.Id, value));
        ...
        {
            Person person = null;
            IOperator op = sql.Op(() => SqlExp.Ge(person.Department.Id, value));
        ...
        {
            Person person = null;
            IOperator op = sql.Op(() => SqlExp.Ge(person.Address.Street, value));
        ...
        {
            Person2 person = null;
            IOperator op = sql.Op(() => SqlExp.Ge(person.Address.City.Country.Name, value));
        ...
        {
            Person person = null;
            IOperator op = sql.Op(() => SqlExp.Ge(person.Image, value));
        ...
        {
            Department dept = null;
            IOperator op = sql.Op(() => SqlExp.Ge(dept.Tags, value));
        ...
        {
            Department dept = null;
            IOperator op = sql.Op(() => SqlExp.Ge(dept.Tags, new List<string> { "abcd", "efgh", "ijkl" }));
        ...
        public void Expression_Method_Column()
        {
            Person person = null;
            Department dept = null;
            IOperator op = sql.Op(() => SqlExp.Ge(person.Department.Id, dept.Id));
        ...
        public void Expression_Method_SubQuery()
        {
            Person person = null;
            IRawQuery query = sql.RawQuery("Subquery");
            IOperator op = sql.Op(() => SqlExp.Ge(person.Id, query));
        ...
        public void Expression_Method_Invalid_Call()
        {
            ...
            Exception ex = Assert.Throws<NotSupportedException>(() => SqlExp.Ge(person.Id, 1));
        ...
        {
            engine.AddOperator(OperatorName.Ge, "TRANSLATED");
        ...
        {
            engine.AddOperator(OperatorName.Ge, "TRANSLATED", true);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.Ge(sql.Gt(person["Id"], 10), sql.Lt(person["Id"], 20));
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.Ge(sql.Add.Add(person["Salary"], 1000m), sql.Multiply.Add(person["Salary"], 2m));
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op1 = sql.Ge(person["Id"], sql.RawQuery("Subquery"));
            IOperator op2 = sql.Ge(sql.RawQuery("Subquery"), person["Id"]);
            IOperator op3 = sql.Ge(sql.RawQuery("Subquery1"), sql.RawQuery("Subquery2"));
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.Ge(person["Id"], sql.Any(sql.RawQuery("Subquery")));
        ...
        {
            IAlias dept = sql.Alias("dept");
            IOperator op = sql.Ge(dept["Tags"], new List<string> { "abcd", "efgh", "ijkl" });
