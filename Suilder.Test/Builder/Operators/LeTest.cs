...
namespace Suilder.Test.Builder.Operators
{
    public class LeTest : BuilderBaseTest
    {
        ...
        public void Builder_Object(object value)
        {
            ...
            IOperator op = sql.Le(person["Id"], value);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.Le(person["Image"], value);
        ...
        public void Builder_Object_List<T>(List<T> value)
        {
            ...
            IOperator op = sql.Le(dept["Tags"], value);
        ...
        public void Builder_Object_Column()
        {
            IAlias person = sql.Alias("person");
            IAlias dept = sql.Alias("dept");
            IOperator op = sql.Le(person["DepartmentId"], dept["Id"]);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.Le((object)null, person["Name"]);
        ...
        {
            Person person = null;
            IOperator op = sql.Le(() => person.Department.Id, value);
        ...
        {
            Person person = null;
            IOperator op = sql.Le(() => person.Address.Street, value);
        ...
        {
            Person2 person = null;
            IOperator op = sql.Le(() => person.Address.City.Country.Name, value);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = person["Id"].Le(value);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = person["Image"].Le(value);
        ...
        {
            IAlias dept = sql.Alias("dept");
            IOperator op = dept["Tags"].Le(value);
        ...
        {
            Person person = null;
            IOperator op = sql.Op(() => SqlExp.Le(person.Id, value));
        ...
        {
            Person person = null;
            IOperator op = sql.Op(() => SqlExp.Le(person.Department.Id, value));
        ...
        {
            Person person = null;
            IOperator op = sql.Op(() => SqlExp.Le(person.Address.Street, value));
        ...
        {
            Person2 person = null;
            IOperator op = sql.Op(() => SqlExp.Le(person.Address.City.Country.Name, value));
        ...
        {
            Person person = null;
            IOperator op = sql.Op(() => SqlExp.Le(person.Image, value));
        ...
        {
            Department dept = null;
            IOperator op = sql.Op(() => SqlExp.Le(dept.Tags, value));
        ...
        {
            Department dept = null;
            IOperator op = sql.Op(() => SqlExp.Le(dept.Tags, new List<string> { "abcd", "efgh", "ijkl" }));
        ...
        public void Expression_Method_Column()
        {
            Person person = null;
            Department dept = null;
            IOperator op = sql.Op(() => SqlExp.Le(person.Department.Id, dept.Id));
        ...
        public void Expression_Method_SubQuery()
        {
            Person person = null;
            IRawQuery query = sql.RawQuery("Subquery");
            IOperator op = sql.Op(() => SqlExp.Le(person.Id, query));
        ...
        public void Expression_Method_Invalid_Call()
        {
            ...
            Exception ex = Assert.Throws<NotSupportedException>(() => SqlExp.Le(person.Id, 1));
        ...
        {
            engine.AddOperator(OperatorName.Le, "TRANSLATED");
        ...
        {
            engine.AddOperator(OperatorName.Le, "TRANSLATED", true);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.Le(sql.Gt(person["Id"], 10), sql.Lt(person["Id"], 20));
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.Le(sql.Add.Add(person["Salary"], 1000m), sql.Multiply.Add(person["Salary"], 2m));
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op1 = sql.Le(person["Id"], sql.RawQuery("Subquery"));
            IOperator op2 = sql.Le(sql.RawQuery("Subquery"), person["Id"]);
            IOperator op3 = sql.Le(sql.RawQuery("Subquery1"), sql.RawQuery("Subquery2"));
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.Le(person["Id"], sql.Any(sql.RawQuery("Subquery")));
        ...
        {
            IAlias dept = sql.Alias("dept");
            IOperator op = sql.Le(dept["Tags"], new List<string> { "abcd", "efgh", "ijkl" });
