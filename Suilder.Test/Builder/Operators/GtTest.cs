...
namespace Suilder.Test.Builder.Operators
{
    public class GtTest : BuilderBaseTest
    {
        ...
        {
            Person person = null;
            IOperator op = sql.Gt(() => person.Address.Street, "SomeName");
        ...
        {
            Person person = null;
            IOperator op = sql.Gt(() => person.Department.Id, 1);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = person["Image"].Gt(new byte[] { 1, 2, 3 });
        ...
        {
            Person person = null;
            IOperator op = sql.Op(() => SqlExp.Gt(person.Address.Street, "SomeName"));
        ...
        {
            Person person = null;
            IOperator op = sql.Op(() => SqlExp.Gt(person.Department.Id, 1));
