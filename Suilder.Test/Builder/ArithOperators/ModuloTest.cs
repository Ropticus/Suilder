...
namespace Suilder.Test.Builder.ArithOperators
{
    public class ModuloTest : BuilderBaseTest
    {
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.Modulo.Add(person["Salary"]);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = person["Salary"].Modulo(value);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = person["Image"].Modulo(value);
        ...
        public void Extension_Object_List<T>(List<T> value)
        {
            ...
            IOperator op = dept["Tags"].Modulo(value);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = person["Name"].Modulo(null);
        ...
        public void Extension_Expression_Column()
        {
            ...
            IOperator op = person["DepartmentId"].Modulo(() => dept.Id);
        ...
        {
            engine.AddOperator(OperatorName.Modulo, "TRANSLATED");
        ...
        {
            engine.AddOperator(OperatorName.Modulo, "TRANSLATED", true);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.Modulo.Add(sql.Gt(person["Id"], 10), sql.Lt(person["Id"], 20));
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.Modulo.Add(sql.Add.Add(person["Salary"], 1000m), sql.Multiply.Add(person["Salary"], 2m));
        ...
        {
            IOperator op = sql.Modulo.Add(sql.RawQuery("Subquery1"), sql.RawQuery("Subquery2"));
