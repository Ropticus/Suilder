...
{
    public class AddTest : BuilderBaseTest
    {
        [Theory]
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.Add.Add(person["Salary"], 100m, value);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.Add.Add(new List<object> { person["Salary"], 100m, value });
        ...
        {
            Person person = null;
            IOperator op = sql.Add.Add(new List<Expression<Func<object>>> { () => person.Salary, () => 100m, () => value });
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.Add.Add(person["Salary"]);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = person["Salary"].Plus(value);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = person["Image"].Plus(value);
        ...
        public void Extension_Object_List<T>(List<T> value)
        {
            ...
            IOperator op = dept["Tags"].Plus(value);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = person["Name"].Plus(null);
        ...
        public void Extension_Expression_Column()
        {
            ...
            IOperator op = person["DepartmentId"].Plus(() => dept.Id);
        ...
        {
            engine.AddOperator(OperatorName.Add, "TRANSLATED");
        ...
        {
            engine.AddOperator(OperatorName.Add, "TRANSLATED", true);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.Add.Add(sql.Gt(person["Id"], 10), sql.Lt(person["Id"], 20));
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.Add.Add(sql.Add.Add(person["Salary"], 1000m), sql.Multiply.Add(person["Salary"], 2m));
        ...
        {
            IOperator op = sql.Add.Add(sql.RawQuery("Subquery1"), sql.RawQuery("Subquery2"));
