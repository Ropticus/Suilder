...
namespace Suilder.Test.Builder.ArithOperators
{
    public class DivideTest : BuilderBaseTest
    {
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.Divide.Add(person["Salary"], 100m, value);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.Divide.Add(new List<object> { person["Salary"], 100m, value });
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.Divide.Add(person["Salary"]);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = person["Salary"].Divide(value);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = person["Image"].Divide(value);
        ...
        public void Extension_Object_List<T>(List<T> value)
        {
            ...
            IOperator op = dept["Tags"].Divide(value);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = person["Name"].Divide(null);
        ...
        public void Extension_Expression_Column()
        {
            ...
            IOperator op = person["DepartmentId"].Divide(() => dept.Id);
        ...
        {
            engine.AddOperator(OperatorName.Divide, "TRANSLATED");
        ...
        {
            engine.AddOperator(OperatorName.Divide, "TRANSLATED", true);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.Divide.Add(sql.Gt(person["Id"], 10), sql.Lt(person["Id"], 20));
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.Divide.Add(sql.Add.Add(person["Salary"], 1000m), sql.Multiply.Add(person["Salary"], 2m));
        ...
        {
            IOperator op = sql.Divide.Add(sql.RawQuery("Subquery1"), sql.RawQuery("Subquery2"));
