...
{
    public class ExceptAllTest : BuilderBaseTest
    {
        [Fact]
        public void Builder()
        {
        ...
        {
            engine.AddOperator(OperatorName.ExceptAll, "TRANSLATED");
        ...
        {
            engine.AddOperator(OperatorName.ExceptAll, "TRANSLATED", true);
        ...
        public void To_String()
        {
            ...
            Assert.Equal("(SELECT person.Name FROM Person AS person) "
                + "EXCEPT ALL (SELECT dept.Name FROM Department AS dept)", op.ToString());
        }
