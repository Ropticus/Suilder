...
{
    public class LeftShiftTest : BuilderBaseTest
    {
        [Theory]
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.LeftShift.Add(person["Flags"], 1, value);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.LeftShift.Add(new List<object> { person["Flags"], 1, value });
        ...
        {
            Person person = null;
            IOperator op = sql.LeftShift.Add(new List<Expression<Func<object>>> { () => person.Flags, () => 1,
                () => value });
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = person["Flags"].LeftShift(value);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = person["Image"].LeftShift(value);
        ...
        public void Extension_Object_List<T>(List<T> value)
        {
            ...
            IOperator op = dept["Tags"].LeftShift(value);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = person["Name"].LeftShift(null);
        ...
        public void Extension_Expression_Column()
        {
            ...
            IOperator op = person["DepartmentId"].LeftShift(() => dept.Id);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.LeftShift.Add(sql.Gt(person["Id"], 10), sql.Lt(person["Id"], 20));
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.LeftShift.Add(sql.Add.Add(person["Salary"], 1000m), sql.Multiply.Add(person["Salary"], 2m));
        ...
        {
            IOperator op = sql.LeftShift.Add(sql.RawQuery("Subquery1"), sql.RawQuery("Subquery2"));
