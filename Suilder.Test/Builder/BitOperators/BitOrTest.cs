...
namespace Suilder.Test.Builder.BitOperators
{
    public class BitOrTest : BuilderBaseTest
    {
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.BitOr.Add(person["Flags"], 1, value);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.BitOr.Add(new List<object> { person["Flags"], 1, value });
        ...
        {
            Person person = null;
            IOperator op = sql.BitOr.Add(new List<Expression<Func<object>>> { () => person.Flags, () => 1, () => value });
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.BitOr.Add(person["Flags"]);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = person["Flags"].BitOr(value);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = person["Image"].BitOr(value);
        ...
        public void Extension_Object_List<T>(List<T> value)
        {
            ...
            IOperator op = dept["Tags"].BitOr(value);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = person["Name"].BitOr(null);
        ...
        public void Extension_Expression_Column()
        {
            ...
            IOperator op = person["DepartmentId"].BitOr(() => dept.Id);
        ...
        {
            engine.AddOperator(OperatorName.BitOr, "TRANSLATED");
        ...
        {
            engine.AddOperator(OperatorName.BitOr, "TRANSLATED", true);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.BitOr.Add(sql.Gt(person["Id"], 10), sql.Lt(person["Id"], 20));
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.BitOr.Add(sql.Add.Add(person["Salary"], 1000m), sql.Multiply.Add(person["Salary"], 2m));
        ...
        {
            IOperator op = sql.BitOr.Add(sql.RawQuery("Subquery1"), sql.RawQuery("Subquery2"));
