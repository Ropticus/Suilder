...
{
    public class BitXorTest : BuilderBaseTest
    {
        [Theory]
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.BitXor.Add(person["Flags"], 1, value);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.BitXor.Add(new List<object> { person["Flags"], 1, value });
        ...
        {
            Person person = null;
            IOperator op = sql.BitXor.Add(new List<Expression<Func<object>>> { () => person.Flags, () => 1, () => value });
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.BitXor.Add(person["Flags"]);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = person["Flags"].BitXor(value);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = person["Image"].BitXor(value);
        ...
        public void Extension_Object_List<T>(List<T> value)
        {
            ...
            IOperator op = dept["Tags"].BitXor(value);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = person["Name"].BitXor(null);
        ...
        public void Extension_Expression_Column()
        {
            ...
            IOperator op = person["DepartmentId"].BitXor(() => dept.Id);
        ...
        {
            engine.AddOperator(OperatorName.BitXor, "TRANSLATED");
        ...
        {
            engine.AddOperator(OperatorName.BitXor, "TRANSLATED", true);
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.BitXor.Add(sql.Gt(person["Id"], 10), sql.Lt(person["Id"], 20));
        ...
        {
            IAlias person = sql.Alias("person");
            IOperator op = sql.BitXor.Add(sql.Add.Add(person["Salary"], 1000m), sql.Multiply.Add(person["Salary"], 2m));
        ...
        {
            IOperator op = sql.BitXor.Add(sql.RawQuery("Subquery1"), sql.RawQuery("Subquery2"));
