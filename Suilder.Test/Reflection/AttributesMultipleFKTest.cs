...
{
    public class AttributesMultipleFKTest : BaseTest
    {
        ...
        public void Columns_Names_List()
        {
            ...
            Assert.Equal(new string[] { "Id", "Active", "Name", "BossId", "BossIdAux" }, deptTable.ColumnNames);
        }
