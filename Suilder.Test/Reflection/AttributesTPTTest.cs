...
{
    public class AttributesTPTTest : BaseTest
    {
        ...
        public void Table_Name()
        {
            ...
            Assert.Equal("Employee", employeeTable.TableName);
        ...
        public void Columns()
        {
            ...
            Assert.Equal(new string[] { "Id", "Guid", "Active", "Name", "Created", "SurName" }, personTable.Columns);
            Assert.Equal(new string[] { "Id", "Salary", "DepartmentId", "Department.Id" }, employeeTable.Columns);
        ...
        public void Columns_Names_List()
        {
            ...
            Assert.Equal(new string[] { "Id", "Guid", "Active", "Name", "DateCreated", "SurName" },
                personTable.ColumnNames);
            Assert.Equal(new string[] { "Id", "Salary", "DepartmentId" }, employeeTable.ColumnNames);
