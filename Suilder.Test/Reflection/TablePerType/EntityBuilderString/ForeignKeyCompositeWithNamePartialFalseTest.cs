    ...
    public class ForeignKeyCompositeWithNamePartialFalseTest : BaseTest
    {
        protected override void InitConfig()
        {
            ...
            tableBuilder.Add<Employee>()
                .ForeignKey("DepartmentId", "DepartmentId2", false)
                .ForeignKey("Department.Id", "DepartmentId2", false)
                .ForeignKey("Department.Guid", "DepartmentGuid2", false);

            tableBuilder.Add<Department>()
                .ForeignKey("Boss.Id", "BossId2", false)
                .ForeignKey("Boss.Guid", "BossGuid2", false);
        }
