...
{
    public class IgnorePrimaryKeyNotExistsTest : BaseTest
    {
        ...
        public void Columns()
        {
            ...
            Assert.Equal(new string[] { "Id", "Guid", "Name", "Surname", "Address.Street", "Address.City" },
                personInfo.Columns);
            Assert.Equal(new string[] { "Id", "Salary", "DepartmentId", "Department.Id", "Image" },
        ...
        public void Column_Names()
        {
            ...
            Assert.Equal(new string[] { "Id", "Salary", "DepartmentId", "Image" },
