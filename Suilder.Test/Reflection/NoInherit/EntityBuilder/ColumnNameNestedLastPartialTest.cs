    ...
    public class ColumnNameNestedLastPartialTest : BaseTest
    {
        protected override void InitConfig()
        {
            tableBuilder.Add<Person>()
                ...
                .ColumnName(x => x.Address.Street, "Street2", true)
                .ColumnName(x => x.DepartmentId, "DepartmentId2", true)
                .ColumnName(x => x.Department.Id, "DepartmentId2", true)
                .ColumnName(x => x.Image, "Image2", true);
        ...
        public void Column_Names()
        {
            ...
            Assert.Equal(new string[] { "Id2", "Guid", "Name2", "Surname", "AddressStreet2", "AddressCity", "DepartmentId2",
