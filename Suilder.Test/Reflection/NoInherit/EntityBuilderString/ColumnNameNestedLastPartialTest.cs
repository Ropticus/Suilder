    ...
    public class ColumnNameNestedLastPartialTest : BaseTest
    {
        protected override void InitConfig()
        {
            tableBuilder.Add<Person>()
                ...
                .ColumnName("Address.Street", "Street2", true)
                .ColumnName("DepartmentId", "DepartmentId2", true)
                .ColumnName("Department.Id", "DepartmentId2", true)
                .ColumnName("Image", "Image2", true);
