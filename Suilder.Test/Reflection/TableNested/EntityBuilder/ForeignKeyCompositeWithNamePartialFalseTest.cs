    ...
    public class ForeignKeyCompositeWithNamePartialFalseTest : BaseTest
    {
        protected override void InitConfig()
        {
            tableBuilder.Add<Person>()
                .ForeignKey(x => x.Employee.DepartmentId, "DepartmentId2", false)
                .ForeignKey(x => x.Employee.Department.Id, "DepartmentId2", false)
                .ForeignKey(x => x.Employee.Department.Guid, "DepartmentGuid2", false);

            tableBuilder.AddNested<Employee>();

            tableBuilder.Add<Department>()
                .ForeignKey(x => x.Boss.Id, "BossId2", false)
                .ForeignKey(x => x.Boss.Guid, "BossGuid2", false);
        }
