...
{
    public class ColumnNameNestedFirstPartialFalseTest : BaseTest
    {
        protected override void InitConfig()
        {
            tableBuilder.Add<Person>()
                ...
                .ColumnName(x => x.Employee, "Employee2", false)
                .ColumnName(x => x.Employee.DepartmentId, "DepartmentId2", false)
                .ColumnName(x => x.Employee.Department, "DepartmentId2", false)
