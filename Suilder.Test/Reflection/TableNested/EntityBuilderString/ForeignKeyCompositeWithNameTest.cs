    ...
    public class ForeignKeyCompositeWithNameTest : BaseTest
    {
        protected override void InitConfig()
        {
            tableBuilder.Add<Person>()
                ...
                .ForeignKey("Employee.Department.Id", "DepartmentId2")
                .ForeignKey("Employee.Department.Guid", "DepartmentGuid2");

            tableBuilder.AddNested<Employee>();

            tableBuilder.Add<Department>()
                .ForeignKey("Boss.Id", "BossId2")
                .ForeignKey("Boss.Guid", "BossGuid2");
        }
