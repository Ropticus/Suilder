    ...
    public class IgnorePrimaryKeyNotExistsInheritTest : BaseTest
    {
        protected override void InitConfig()
        {
            ...
            tableBuilder.Add<Person>()
                .PrimaryKey(x => x.FullName)
                .Ignore(x => x.Address);

            tableBuilder.Add<Employee>()
                .PrimaryKey(x => x.FullName)
                .PrimaryKey(x => x.Address.Street);

            tableBuilder.Add<Department>()
                .PrimaryKey(x => x.Employees);
        }
        ...
        public void Columns()
        {
            ...
            Assert.Equal(new string[] { "Id", "Guid", "Name", "Surname", "Salary", "DepartmentId", "Department.Id",
        ...
        public void Column_Names()
        {
            ...
            Assert.Equal(new string[] { "Id", "Guid", "Name", "Surname", "Salary", "DepartmentId", "Image" },
